...
<?php include_once('layouts/blog/category-list.php') ?>        
...
<script type="text/javascript">
  ...
  $('#modal-form-add-category').on('submit',function(){ //alert('OK');
    $.ajax({
      url:base_url_web+'/adw-category/add-validate',
      method:'post',
      //dataType:'text',
      data:$('#modal-form-add-category').serialize(),
      success:function(r){ 
        location.reload();
      }
    });
