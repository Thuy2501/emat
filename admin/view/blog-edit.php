            ...
            if(typeof data=='object'){ //console.log(data['avatar']);
              if(data['code']==200){
                if(data['avatar']!=''){
                  ...
                  $('#blog-avatar2').val(data['avatar']);
                  $('#blog-avatar_alt2').val(data['alt']);
                }
...
function saveSiteContent(id) { //console.log(222);
  ...
  sys_preLoadSubmit();
  $.ajax({
        url:base_url_web+'/adw-blog/form-editcontent',
        method:'post',
        data:{
          id:id,
          name:$('#site-content-listname-'+id).val(),
          color:$('#site-content-color-'+id).val(),
...
function addSiteContent(id) { //console.log(222);
  ...
  $.ajax({
        url:base_url_web+'/adw-blog/form-addcontent',
        method:'post',
        data:{
          id:$('#blog-id').val(),
...
function removeSiteContent(id){
  if(confirm("Bạn muốn xóa bản ghi này ?")){
    sys_preLoadSubmit();
    $.ajax({
          url:base_url_web+'/adw-blog/form-removecontent',
          method:'post',
          data:{
            id:id
          },
